...
<head>
  <title>H@lp -- nous contacter</title>
...
<body>
  <div id="main">
	...
	<div id="menubar">
      <ul id="menu">
        ...
        <li><a href="ourwork.php">Nous connaître</a></li>
        <li><a href="projects.php">Notre projet</a></li>
        <li><a href="heberg.php">Notre Hébergeur</a></li>
	...
	<div id="site_content">	
      ...
      <div id="content">
        <div class="content_item">
          ...
          <p>&nbsp;</p>
          <div style="width:430px; float:right;"><p><input class="contact" type="text" name="your_name" value="" /></p>
            <p>&nbsp;</p>
          </div>
          ...
          <div style="width:430px; float:right;"><p><input class="contact" type="text" name="your_email" value="" /></p></div>
            <div style="width:120px; float:left;"><p>Message</p>
            </div>
  ...
  <div id="footer">
	  <a href="http://validator.w3.org/check?uri=referer">Projet ISN 2014-2015 MOYSE HORNOY</a><a href="http://www.araynordesign.co.uk"></a>
  </div><!--close footer-->  	
